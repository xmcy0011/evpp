// auth xmcy0011@sina.com
// date: 2021-05-24
// brief:
//  thinks: [goim](https://github.com/Terry-Mao/goim)
//  copy from: https://github.com/Terry-Mao/goim/blob/master/examples/javascript/client.js
//
...
(function (win) {
  ...
  Client.prototype.createConnect = function (max, delay) {
    ...
    function connect() {
      ...
      //var ws = new WebSocket("ws://localhost:8002/sub");
      self.ws = new WebSocket("ws://10.32.80.75:8002/sub");
        ...
        switch (op) {
          case 8:
            ...
            document.getElementById("status").innerHTML =
              "<color style='color:green'>ok<color>";
      ...
      self.ws.onclose = function () {
        ...
        document.getElementById("status").innerHTML =
          "<color style='color:red'>failed<color>";
      };
  ...
  // send msg, msgBody: String
  var gSeq = 0;
  Client.prototype.sendMsg = function (msgBody) {
    var msg =
      '{"msgContent":' +
      msgBody +
      ', "sessionType":1, "to":[1000,1001,1002],"from":10086}';
    var headerBuf = new ArrayBuffer(rawHeaderLen);
    var headerView = new DataView(headerBuf, 0);
    var textEncoder = new TextEncoder();
    ...
    headerView.setInt32(seqOffset, gSeq++);
